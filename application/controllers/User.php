...
class User extends REST_Controller
{
  ...
  function listcomplaints_get(){
      ...
      */
      ...
      $complaintsdata[4] = $this->get('hostel');
      $complaintsdata[5] = $this->get('resolved');

      $this->load->model('Data_operations');
      $response = array("complaints"=> $this->Data_operations->getcomplaints($complaintsdata));
      json_encode($response);
      $this->response($response, 200);
  }
...
>>>>>>> fe76d3acfa86f75819615f3d20d1d17832136127
			}
			else
			{
				$response=array('success'=>'false') ;
